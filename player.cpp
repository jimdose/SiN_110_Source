...
// 
// 450   11/02/99 12:09p Markd
// Fixed CTF cheat bug
// 
// 449   10/28/99 10:43a Markd
// made a bunch of console commands cheat protected
// 
// 448   7/25/99 7:06p Markd
// Fixed major deathmatch cheat
// 
// 447   6/14/99 2:11p Markd
// initialize grapple_pull to false in the constructor
// 
// 446   5/19/99 11:30a Markd
// Added new camera support 
// 
// 445   5/18/99 7:07p Aldie
// Fix for ctf_forcejoin
// 
// 444   4/16/99 5:02p Aldie
// Added takeallammo to dropweapon
// 
// 443   4/02/99 5:14p Markd
// Added MOD for dedicated server support
// 
// 442   3/25/99 6:29p Aldie
// Fixed grappling hook crash bug
// 
// 441   3/24/99 4:39p Aldie
// Changed death messages to reliable
// 
// 440   3/24/99 10:35a Markd
// Hopefully fixed a crash bug with spectator and events
// 
// 439   3/22/99 2:08p Aldie
// Bulletproofed flag dropping from players
// 
// 438   3/19/99 9:00p Aldie
// Added spectator_distance for spectator camera
// 
// 437   3/19/99 7:36p Aldie
// Added bulletproofing for being in a vehicle and choosing spectator
// 
// 436   3/19/99 5:59p Aldie
// Added dropweapon and dropflag
// 
// 435   3/19/99 5:04p Aldie
// Fixed spectator mode (major overhaul) temporarily disabled MOD on client
// messages
// 
// 434   3/19/99 2:12p Aldie
// Changed deathmessages
// 
// 433   3/17/99 4:00p Aldie
// CTF Update
// 
// 432   3/16/99 12:41p Aldie
// Fixed spectator bug
// 
// 431   3/16/99 11:50a Aldie
// Fix for dropped flag stuff
// 
// 430   3/12/99 10:27p Aldie
// Added obit for deathquad
// 
// 429   3/12/99 10:18p Aldie
// Changed the sounds
// 
// 428   3/12/99 7:40p Jimdose
// fixed possible cheats in spectator mode:
// spectators no longer touch things (so items can't be picked up)
// spectators no longer can grapple
// spectators can no longer be hurt by explosions
// 
// 427   3/11/99 3:46p Aldie
// Added some meansofdeath messages
// 
// 426   3/05/99 5:58p Markd
// Added vehicle use support
// 
// 425   3/05/99 5:47p Aldie
// Added thrallball mod
// 
// 424   3/03/99 12:38p Aldie
// Fix some stuff for CTF gravaxis and hook
// 
// 423   3/02/99 9:14p Aldie
// Added CTF game code
// 
...
void Player::CTF_JoinTeamHardcorps
	(
	Event *ev
	)
...
void Player::CTF_JoinTeamSintek
	(
	Event *ev
	)
...
void Player::CTF_UpdateNumberOfPlayers
	(
	void
	)
      ...
      if ( viewmode == FIRST_PERSON )
         ...
         if ( cl_ent && cl_ent->entity && cl_ent->entity->client )
            ...
            Com_sprintf( entry, sizeof( entry ),
			      "client %i %i %i %i %i %i ",
			       100, 176, currentCameraTarget, cl_ent->entity->client->resp.score, cl_ent->entity->client->ping, ( level.framenum - cl_ent->entity->client->resp.enterframe ) / 600 );
            gi.WriteByte (svc_layout);
	...
	if ( tech = ( CTF_Tech * )HasItemOfSuperclass( "CTF_Tech" ) )
      {
		...
		tech->setOrigin( worldorigin + "0 0 80" );
...
void Player::CTF_DropFlag
   ...
   if ( dropped_flag = FindItem( enemy_flag.c_str() ) )
      ...
      dropped_flag->RandomAnimate( "idle", NULL );
		...
		dropped_flag->setOrigin( worldorigin + "0 0 80" );
...
void Player::CTF_UpdateHookBeam
   (
   Event *ev
   )
